        ...
        <div class="container" style="margin-top: 80px; @if ($counts > 1) margin-bottom:80px @endif">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <p style="color: black">Quantity in stock: <b style="color: orange">{{$prod->quantityInStock}}</b></p>
                    <p style="color: black">Price: <b style="color: orange">{{number_format($prod->Price, 0, '.', ' ')}} Ar</b></p>
                    <p style="color: black">
                        {{$prod->Description}}
                    </p>
                    <a href="{{route('Public.Contact.product', ['id' => $prod->id])}}" class="btn btn-primary">Ask for information</a>
                </div>
            </div>
